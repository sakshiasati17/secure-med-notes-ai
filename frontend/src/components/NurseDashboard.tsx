...
**Patient Response**: ${noteForm.patient_response}`,
  ...
  const quickActions = [
    { label: 'Add Note', icon: '📝', targetTab: 'notes' as const, subTab: 'nurse-notes' as const },
    { label: 'Record Vitals', icon: '🩺', targetTab: 'notes' as const, subTab: 'vitals' as const },
    { label: 'Medication Log', icon: '💊', targetTab: 'patients' as const, subTab: null },
    { label: 'View Tasks', icon: '📋', targetTab: 'notes' as const, subTab: 'tasks' as const },
  ];
    ...
    <div className={`min-h-screen ${bgClass} transition-colors duration-300`}>
      ...
      <div className="relative z-10">
          ...
          <div className="max-w-7xl mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className={`text-2xl ${textClass}`}>Hello, Nurse Sarah</h1>
        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          {activeTab === 'analytics' && <AIAnalyticsTab darkMode={darkMode} tasks={analyticsTasks} setActiveTab={setActiveTab} />}
