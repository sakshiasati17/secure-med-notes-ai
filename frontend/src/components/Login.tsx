...
import { Lock, Mail, Eye, EyeOff, ArrowLeft, Stethoscope, Heart, Moon, Sun, AlertCircle } from 'lucide-react';
        ...
        <div className={`relative ${cardBgClass} backdrop-blur-xl rounded-[2.5rem] p-10 shadow-2xl border`}>
          ...
          <div className="relative z-10">
            ...
            <div className="text-center mb-8">
              ...
              <h2 className={`text-3xl ${textClass} mb-2`}>Secure Login</h2>
              <p className={textSecondaryClass}>Select your role and authenticate to continue</p>
            </div>
